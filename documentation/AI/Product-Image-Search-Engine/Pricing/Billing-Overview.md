...
### 4、接口购买说明
为了满足图片搜索的需求，需要先使用图片入库接口将图片存入，后使用图片搜索接口进行搜索；故图片入库及图片搜索两个接口需要分别购买。

### 5、其他说明
您理解并同意，京东智联云有权根据实际情况随时单方调整免费额度、费用标准及收费方式，而无需获得您的事先同意，京S东智联云会尽合理范围内的最大努力，将前述调整及变化，通过官网公告、站内通知或您预留的联系信息等方式提前告知您，且调整日之前已经购买并已全额支付费用的服务不受影响。

商品图片搜索需要在控制台中，分别购买“商品图片搜索入库”、“商品图片搜索检索”两个接口才能实现业务需求

## 二、价格说明
按调用量进行计费，如有更高额度需求，请联系客服。
